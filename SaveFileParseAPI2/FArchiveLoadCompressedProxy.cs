...
public class FArchiveLoadCompressedProxy : FArchive
    {
        ...
        public FArchiveLoadCompressedProxy(string name, byte[] compressedData, string compressionFormat, ECompressionFlags flags = ECompressionFlags.COMPRESS_None /*, VersionContainer? versions = null*/) : base(/*versions*/)
        {
            Name = name;
